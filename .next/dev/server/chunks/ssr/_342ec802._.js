...
const fetchNoteById = async (id)=>{
    const res = await axios.get(`${noteHubAPIUrl}/${id}`, {
        headers
    });
    return res.data;
};
const fetchNotes = async (search, page)=>{
    ...
    const response = await axios.get(noteHubAPIUrl, options);
    return {
...
const createNote = async ({ title, content, tag })=>{
    ...
    const response = await axios.post(noteHubAPIUrl, params, {
        headers
    });
...
const NoteList = ({ notes })=>{
    ...
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async (noteId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteNote"])(noteId),
        onSuccess: ()=>{
...
const NotesByCategory = async ({ params })=>{
    ...
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getNotes"])(category);
...
const NotePage = async ({ params })=>{
    ...
    if (slug.length !== 1) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["notFound"])();
    const categoryId = slug[0];
    const isValid = categoryId === "all" || (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCategories"])()).find((category)=>category.id === categoryId);
    if (!isValid) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["notFound"])();
...
//# sourceMappingURL=_342ec802._.js.map
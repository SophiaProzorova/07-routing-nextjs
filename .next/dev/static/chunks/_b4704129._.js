...
function NotesClient() {
    ...
    if ($[0] !== "3cd8f02227e18e171c244fb11b19ca5caa4b6d4449898f625f04a0bd76b6b3b6") {
        for(let $i = 0; $i < 29; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3cd8f02227e18e171c244fb11b19ca5caa4b6d4449898f625f04a0bd76b6b3b6";
    }
    ...
    const updateSearchQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$debounce$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebouncedCallback"])(t0, 300);
    let t1;
    ...
    let t4;
    if ($[6] !== currentPage || $[7] !== searchQuery) {
        t4 = {
            queryKey: [
                "notes",
                currentPage,
            ...
            queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNotes"])(searchQuery, currentPage),
    ...
    const { data } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t4);
...
//# sourceMappingURL=_b4704129._.js.map